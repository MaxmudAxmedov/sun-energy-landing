    ...
    <>
      <div className="container lg:w-[1200px] mx-auto">
        <div id="biz_haqimizda" className="biz haqimizda mt-[87px] mb-[102px] ">
          <h2 className="font-[700] text-[24px] text-grey mb-[25px] pl-[10px] lg:pl-[0px]">
            Biz haqimizda
          </h2>
          <p className="font-[700] text-[20px] text-black mb-[42px] pl-[10px] lg:pl-[0px]">
          ...
          <div className="flex flex-wrap gap-[32px] justify-center mx-auto mb-[65px] ">
            <div className="bg-yellow rounded-[12px] w-[558px]">
              <p className="font-[400] text-[17px] md:text-[19px] text-white py-[26px] px-[15px] ">
                ...
                yaxshilash hamda malakali kadrlar bilan ishlash imkoniyatini
                beradi.
              </p>
            </div>
            <div className="bg-yellow rounded-[12px] w-[558px]">
        ...
        >
          <h2 className="font-[700] text-[24px] text-grey mb-[60px] pl-[10px] lg:pl-[0ppx]">
            Loyihalarimiz
          </h2>
          <div>
            <LoyihalarimizSwiper />
